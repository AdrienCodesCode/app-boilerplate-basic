...
app.use(express.urlencoded({ extended: true }));    // Parses form data (the kind you get from HTML <form> submissions) (4)
...
/*
(6) ERROR HANDLER - custom from the error class extension
